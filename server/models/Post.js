...
const PostSchema = new mongoose.Schema(
  {
    ...
    content: {
      type: String,
      maxlength: [MAX_POST_CONTENT_LENGTH, `Content cannot exceed ${MAX_POST_CONTENT_LENGTH} characters`],
      default: ''
    },
    images: {
      type: [String],
    ...
    repostComment: {
      type: String,
      maxlength: [MAX_REPOST_COMMENT_LENGTH, `Repost comment cannot exceed ${MAX_REPOST_COMMENT_LENGTH} characters`]
    },
    originalPost: {
      type: mongoose.Schema.Types.ObjectId,
      ref: "Post"
